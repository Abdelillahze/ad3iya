...
var douaa = document.querySelector(".douaa");

function generate() {
  var number = Math.floor(Math.random() * 1000);
  var number2 = Math.floor(Math.random() * ad3iya.length);
  document.body.style.backgroundColor = `hsl(${number}deg 70% 54%)`;
  console.log(number2);
  douaa.innerHTML = ad3iya[number2];
}
generate();
